...
def parse_args():
    ...
    parser.add_argument("--model", choices=[
        ...
        "mstgc_wo_channel_attention",
        "mstgc_graph_prior", "mstgc_graph_plv", "mstgc_graph_correlation",
        "mstgc_graph_multigraph",
...
def main():
    ...
    for subject in subjects:
        ...
        try:
            subject_splits = make_splits(dataset, args.protocol, subject, seed=args.seed,
    ...
    if args.master_summary:
        append_master_summary(results, args.master_summary, {
            ...
            "temporal_filters": args.temporal_filters if args.model == "tsmnet" else "",
            "spatial_filters": args.spatial_filters if args.model == "tsmnet" else "",
            "subspacedims": args.subspacedims if args.model == "tsmnet" else "",
            "temp_kernel": args.temp_kernel if args.model == "tsmnet" else "",
            ...
            "mstgc_temporal_mode": results[0].get("mstgc_temporal_mode", "") if args.model in MSTGC_ABLATION_MODELS else "",
            "mstgc_temporal_kernels": results[0].get("mstgc_temporal_kernels", "") if args.model in MSTGC_ABLATION_MODELS else "",
            "model_parameters": results[0].get("model_parameters", ""),
